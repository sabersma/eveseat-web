@extends('web::alliance.layouts.view', ['viewname' => 'structures', 'breadcrumb' => trans_choice('web::seat.structure', 2)])

@section('page_header', trans_choice('web::seat.alliance', 1) . ' ' . trans_choice('web::seat.structure', 2))
...
@section('alliance_content')
  ...
  @include('web::alliance.structures.modals.fitting.fitting')
